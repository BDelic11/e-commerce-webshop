/*
  ...
  - Made the column `updateAt` on table `Product` required. This step will fail if there are existing NULL values in that column.
...
-- CreateEnum
CREATE TYPE "ProductCategories" AS ENUM ('PATULJAK', 'VIJENAC', 'OSTALO');
...
-- CreateTable
CREATE TABLE "TemporaryUserWallet" (
    "id" SERIAL NOT NULL,
    "userId" INTEGER NOT NULL,
    "saldo" DOUBLE PRECISION NOT NULL,

    CONSTRAINT "TemporaryUserWallet_pkey" PRIMARY KEY ("id")
);

-- CreateIndex
CREATE UNIQUE INDEX "TemporaryUserWallet_userId_key" ON "TemporaryUserWallet"("userId");
...
-- AddForeignKey
ALTER TABLE "TemporaryUserWallet" ADD CONSTRAINT "TemporaryUserWallet_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
